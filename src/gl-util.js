...
GlUtil.prototype.switchFramebuffer = function (fi, ti) {
    this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, this.framebuffers[fi][0])
    if (ti !== 0) this.gl.bindTexture(this.gl.TEXTURE_2D, this.framebuffers[ti][1])
}
